...
export const MOCK_USERS: User[] = [
    { id: 'u1', email: 'admin@hrportal.com', password: 'password', role: 'admin' }, // Super Admin
    { id: 'u2', email: 'candidate@example.com', password: 'password', role: 'candidate', profileId: 'p1' },
    { id: 'u3', email: 'company@example.com', password: 'password', role: 'company', companyId: 'c1' },
    { id: 'u4', email: 'company2@example.com', password: 'password', role: 'company', companyId: 'c2' },
    { id: 'u5', email: 'company3@example.com', password: 'password', role: 'company', companyId: 'c3' },
    { id: 'u6', email: 'company4@example.com', password: 'password', role: 'company', companyId: 'c4' },
    { id: 'u7', email: 'ditalent@example.com', password: 'password', role: 'company', companyId: 'c-ditalent' },
    { id: 'u8', email: 'recruiter@hrportal.com', password: 'password', role: 'admin', roleId: 'role_recruiter' },
    { id: 'u9', email: 'content@hrportal.com', password: 'password', role: 'admin', roleId: 'role_content' },
    { id: 'u10', email: 'admin@ditalent.com', password: 'password', role: 'admin' } // Nuevo usuario administrador
];
