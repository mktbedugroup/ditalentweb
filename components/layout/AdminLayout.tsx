    ...
    const sidebarContent = (
        <div>
            ...
            <nav className="mt-10 px-2 space-y-1">
                ...
                {hasPermission('manage_submissions') && <SidebarLink to="/admin/newsletter" icon={<svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>}>{t('admin.sidebar.newsletter')}</SidebarLink>}
